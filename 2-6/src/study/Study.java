...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        // その理由をコメントへ記述してください。
        // [Calendar.MONTH はJANUARY(実値=0)〜UNDECIMBER(実値=11) まで定義が存在し、
        // 実際の月の値は、「-1」の値を保持しているため、「+1」することで実際に表示される月の値を調整しています。
        // 繰り上げや繰り下げの対応をしたい場合、getメソッドで対応してしまうと、あくまで「月の値 + 1」であるため、
        // 「13月、14月、15月」という表示になってしまい、年の加算減算はしないためです。]
